...
void View::createMonthlyPlansWindow( const std::vector < std::shared_ptr < Plan>> &plans, const string &month )
{
    createPlansWindow( plans );
...
//create window that contains menu
...
//create window that contains prompts for user
...
//create window that contains data enetered by a user
