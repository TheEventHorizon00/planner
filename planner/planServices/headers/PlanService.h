...
public:
    ...
    static void createMonthlyPlan( const std::string &month, const std::unique_ptr < View > &view );
    ...
    static std::string getMonthFromUserForCreatingPlan( const std::unique_ptr < View > &view );
