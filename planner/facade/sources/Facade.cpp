...
//choose a plan from a list which you want to change
...
void Facade::performAppropriateAction( char ch )
{
    ...
    case 'e':
        ...
        break;
    case 'o':
        month = planService->getMonthFromUserForCreatingPlan( view );
        planService->createMonthlyPlan( month, view );
        printMonthlyPlans();
        break;
    case 'n':
...
void Facade::printDailyPlans()
{
    ...
    sqlConnection->readAllDailyPlans( plans, date );
...
void Facade::printWeeklyPlans()
{
    ...
    sqlConnection->readAllWeeklyPlans( plans, weekNumber );
...
void Facade::printMonthlyPlans()
{
    ...
    unique_ptr < SQLConnection > sqlConnection( new SQLConnection() );
    sqlConnection->readAllMonthlyPlans( plans, month );

    view->createMonthlyPlansWindow( plans, month );
}
...
void Facade::printAnnualPlans()
{
    ...
    unique_ptr < SQLConnection > sqlConnection( new SQLConnection() );
    sqlConnection->readAllAnnualPlans( plans, year );
